...
Entre los problemas que resolvimos, la mayoria los resolvió rápidamente, nunca demorando más de 5 minutos.

En la mayoria de los problemas fáciles no se llegaba ni a la primera iteración de un ciclo
...
Para problemas más avanzados ahi si se notó la utilización de 1 o más ciclos principales.

Utilizamos estos problemas más avanzados para testear los distintos parametros del algoritmo. En particular
...
Posteriormente evaluamos que ocurria si decrementabamos la cantidad de feromona de 0.999 a 0.809 utilizando
...
Respecto a Ant Colony lo que notamos es que la cantidad de hormigas a utilizar para problemoas
fácil afecta despreciablemente sobre el tiempo de ejecucición, dado que encuentra una solución con
...
En cuanto a las variaciones al factor de evaporizacion de la feromona, nuevamente para los casos fáciles
este valor no afecta, dado que no llega a utilizarse la feromona en la busqueda de la solución optima.

No obstante para los problemas más dificil, este valor toma mayor significancia, dado que al iterar más 
de una vez, la feromona comienza a ser compartir y utilizada por las iteraciones posteriores de grupos
...
la idea del algoritmo. Nuestra implementación resulto funcionar mucho más rápido en terminos de cantidad
de ciclos y de hormigas.

Creemos que estas diferencias pueden ser por dos cosas: 
Por un lado podria ser que no probamos el mismo caso que fue evaluado en el paper. Si bien comparamos nuestras
...
Intentamos comunicarnos con quien escribio el paper para resolver estas dudas, pero no obtuvimos exito.
